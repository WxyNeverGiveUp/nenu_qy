...
* 	初始生成 
* ---------------------------------------------------------------------------*/
KISSY.add('module/detail',function(S,detail){
	PW.namespace('module.popCheck');
	PW.module.detail = function(){
		new detail();
	}
},{
...
KISSY.add('detail/detail',function(S){
	...
	requires:['event','io/module/detail','mod/dialog']
})
