...
<head>
  <meta charset = "utf-8"/>
  <title>东北师范大学网上签约管理系统 -- 数据管理 -- 生源结构</title>
...
<div class="continer">
  ...
  <div class="content">
      ...
      <div class="block-content clearfix">
        ...
        <div class="control-area control-area-short">
          ...
          <select class="textTheme" autocomplete="off" name="dimension2">
            <option value="0">请选择</option>
            <option value="whereaboutgo">毕业去向分布</option>
            <option value="place_class">就业地区类型</option>
            <option value="job_region">就业区域流向</option>
            <option value="job_province">就业省份流向</option>
            <option value="ins_mode">就业单位性质</option>
            <option value="ins_field">就业单位行业</option>
          </select>
        </div>
        <div class="btn-right">
    ...
    <div class="block">
      <div class="block-header">
        <a href="exportEmploymentStructureExcel?id=id" class="btn-right btn J_export">导出结果</a>
      </div>
      <div class="block-content clearfix">
        <table>
          <caption>生源结构</caption>
          ...
          <script id="tpl-th" type="text/template">
            {@each data as d}
            <th data-id="&{d.id}" colspan="2">&{d.name}</th>
            {@/each}
          </script>
          ...
          <script id="tpl-thInfo" type="text/template">
            ...
            <th>
              <div class="pad-left">
                <span>比例</span>
                    <span>
                      <a class="a-top" href="javascript:;" data-orderby="0"> </a>
                      <a class="a-bottom" href="javascript:;" data-orderby="1"> </a>
                    </span>
              </div>
            </th>
            {@/each}
...
<script type="text/javascript">
  KISSY.use('page/employment/structEmp',function(S){
    S.ready(function(){
      PW.page.structEmp({
        ...
        url:'${website}data/queryEmploymentStructure',//必选，必须指定ajax的url
