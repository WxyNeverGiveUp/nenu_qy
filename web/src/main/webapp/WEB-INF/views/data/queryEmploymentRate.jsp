...
<head>
  <meta charset = "utf-8"/>
  <title>东北师范大学网上签约管理系统 -- 数据管理 -- 就业率</title>
...
<div class="continer">
  ...
  <div class="content">
    ...
    <div class="block">
      <div class="block-header">
        <a href="exportEmploymentRateExcel?id=id" class="btn-right btn J_export">导出结果</a>
      </div>
      <div class="block-content clearfix">
        <table>
          <caption>就业率</caption>
...
<script type="text/javascript">
  KISSY.use('page/employment/rate',function(S){
    S.ready(function(){
      PW.page.rate({
        ...
        url:'${website}data/queryEmploymentRate',//必选，必须指定ajax的url
