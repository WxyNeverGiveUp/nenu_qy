  ...
  <div class="content">
    ...
    <form class="block J_searchForm" >
      ...
      <div class="block-content clearfix">
        ...
        <div class="control-area control-area-short">
          <label>维度一</label>
          <select class="textTheme" autocomplete="off" data-valid-rule="scale(0,1000,0)" name="dimension1">
      ...
      <div class="block">
        <div class="block-header">
          <a href="exportStudentStructureExcel?id=id" class="btn-right btn J_export">导出结果</a>
        </div>
        <div class="block-content clearfix">
          <table>
...
<script type="text/javascript">
  KISSY.use('page/employment/structure',function(S){
    S.ready(function(){
      PW.page.structure({
        ...
        url:'${website}data/queryStudentStructure',//必选，必须指定ajax的url
