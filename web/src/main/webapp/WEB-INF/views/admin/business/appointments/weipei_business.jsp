...
<jsp:include page="../../../common/Asidebar.jsp"/>
	...
	<div class="content">
		...
		<div class="stu_query">
			...
			<form  class="query_selects clearfix" method="post" action="/admin/protocol/new/export/4">
				...
				<div class="each_query">
					...
					<select class="query_select" id="protocolType" name="protocolType">
						...
						<option value="9">定向生领协议</option>
						<option value="10">委培生解约领协议</option>
						<option value="11">定向生解约</option>
					</select>
				</div>
				<div class="each_query">
...
<script type="text/javascript">
    KISSY.use('page/admin_page/business_handling/protocolList', function(S) {
        ...
        var url = urls.weipeiBusinessList;//传出来的数据
        var $ = S.all;
        console.log(url);
        S.ready(function(){
