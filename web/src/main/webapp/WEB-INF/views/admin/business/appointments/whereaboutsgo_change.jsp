...
<jsp:include page="../../../common/Asidebar.jsp"/>
	...
	<div class="content">
		...
		<div class="stu_query">
			...
			<form  class="query_selects clearfix" method="post" action="/admin/protocol/new/export/2">
				...
				<div class="each_query">
					...
					<select class="query_select" id="protocolType" name="protocolType">
						...
						<option value="5">放弃考研/博领协议</option>
						<option value="6">放弃出国/出境领协议</option>
					</select>
				</div>
				<div class="each_query">
...
<script type="text/javascript">
    KISSY.use('page/admin_page/business_handling/protocolList', function(S) {
        ...
        var url = urls.whereaboutsgoChangeList;//传出来的数据
        var $ = S.all;
        console.log(url);
        S.ready(function(){
