...
<jsp:include page="../../../common/Asidebar.jsp"/>
	...
	<div class="content">
		...
		<div class="stu_query">
			...
			<form  class="query_selects clearfix" method="post" action="/admin/protocol/new/export/3">
				...
				<div class="each_query">
					...
					<select class="query_select" id="protocolType" name="protocolType">
						...
						<option value="7">免师解约</option>
						<option value="8">免师跨省</option>
					</select>
				</div>
				<div class="each_query">
...
<script type="text/javascript">
    KISSY.use('page/admin_page/business_handling/protocolList', function(S) {
        ...
        var url = urls.normalBusinessList;//传出来的数据
        var $ = S.all;
        console.log(url);
        S.ready(function(){
