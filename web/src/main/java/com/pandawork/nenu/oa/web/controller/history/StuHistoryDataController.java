package com.pandawork.nenu.oa.web.controller.history;
...
/**
 * Created by zy on 2017/7/27.
 */
@Controller
@RequestMapping(value = URLConstants.ADMIN_STU_HISTORY_URL)
public class StuHistoryDataController extends AbstractController {
    ...
    public String toList(Model model){
        try{
            ...
            if (subject.hasRole("counsellor") || subject.hasRole("college-secretary")) {
    ...
    public JSONObject getList(
        ...
        try {
            ...
            String username = subject.getPrincipal().toString();
            List<String> colleges = null;
            if (subject.hasRole("college-secretary")||subject.hasRole("counsellor")){
                    colleges = userInfoService.listCollegesByUserName(username);
                if (Assert.isEmpty(colleges) || colleges.size() <= 0){
                    colleges.add("0");
                }
